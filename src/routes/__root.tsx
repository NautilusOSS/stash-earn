...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cash Stash — A simple place to keep cash and earn yield" },
      { name: "description", content: "Cash Stash is a radically simple savings app. Earn competitive yield on your cash with no jargon, no complexity." },
      { name: "author", content: "Cash Stash" },
